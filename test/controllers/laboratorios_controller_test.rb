...
class LaboratoriosControllerTest < ActionController::TestCase
  ...
  test "should create laboratorio" do
    assert_difference('Laboratorio.count') do
      post :create, laboratorio: { descripcion_laboratorio: @laboratorio.descripcion_laboratorio, id_sede: @laboratorio.id_sede, piso_laboratorio: @laboratorio.piso_laboratorio }
    end
  ...
  test "should update laboratorio" do
    patch :update, id: @laboratorio, laboratorio: { descripcion_laboratorio: @laboratorio.descripcion_laboratorio, id_sede: @laboratorio.id_sede, piso_laboratorio: @laboratorio.piso_laboratorio }
    assert_redirected_to laboratorio_path(assigns(:laboratorio))
  end
